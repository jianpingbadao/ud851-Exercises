...
public class NotificationUtils {
    ...
    public static final int PENDING_INTENT_ID = 1180;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1175;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        Log.v("NotificationUtils", "remindUserBecauseCharging");
